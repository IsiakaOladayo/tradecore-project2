...
output "vpc_cidr_block" {
  description = "CIDR block of the Tradecore VPC"
  value       = aws_vpc.tradecore.cidr_block
}

output "internet_gateway_id" {
  description = "ID of the Internet Gateway"
  value       = aws_internet_gateway.tradecore.id
}
...
output "private_subnet_ids" {
  description = "IDs of the private subnets (one per AZ), used by the database tier"
